        ...
        <table class="table table-striped">
          ...
          <tbody>
            <tr ng-repeat="user in users">
              ...
              <td>@{{ user.supplierEmail }}</td>
              <td>@{{ user.supplierContact }}</td>
              <td>@{{ user.supplierPosition }}</td>
              <td>
                <button class="btn btn-warning btn-xs btn-detail" ng-click="toggle('edit', user.id)">
